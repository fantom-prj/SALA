...
v1.0.1 [June 22, 2022]
   ...
   -fixed hyperactive loci annotation bug
   -locus string added to the output locus info table output
   -added pseudocount_correction opt
	-modified Rscript bin check string [May 21, 2023 1:50 PM]
...
my ($curntTimeStamp) = &timeStamp();#->3406
...
my ($addon_length, $up_end5Rng, $dn_end5Rng, $tssCluster_bed_path, $tssCluster_info_path, $CRE_extend_size, $CRE_extend_upstrm_ratio, $genome, $distal_stitch_distance, $min_total_exp_frac, $min_gene_strand_read_frac, $min_spreadness, $proximal_extend_nt, $min_CRE_count, $pseudocount_correction, $Rscript_bin, $excl_chrom, $outputPrefix, $outDir, $overwrite) = &readParameters();#->2985
#<\section>
#====================================================================================================================================================#
...
&logCalledCMDAndScript($ARGVStr, $result_script_dir, $scriptAbsPath);#->1617
&printStartOrFinishMessage("startMessage");#->2027
...
my ($chrom_size_hsh_ref) = &readChromSize($chrom_size_path);#->2757
my ($trnscptInfoHsh_ref, $transcript_in_scope_bed_path) = &readTranscriptBed($transcript_bed_path, $chrom_size_hsh_ref, $tmp_bed_dir, $outDir);#->3056
my ($geneInfoHsh_ref) = &readTranscriptInfo($transcript_info_path, $trnscptInfoHsh_ref);#->3135
&readGeneInfo($gene_info_path, $geneInfoHsh_ref);#->2913
&addAnnoGeneInfoLoc($geneInfoHsh_ref, $trnscptInfoHsh_ref);#->309
my ($coding_class_hsh_ref) = &defineCodingClasses();#->1018
my ($end5_rng_bed_path, $end5_point_bed_path) = &printEnd5Bed($trnscptInfoHsh_ref, $up_end5Rng, $dn_end5Rng, $tmp_bed_dir);#->1781
my ($clusterInfoHsh_ref) = &readClusterBed($tssCluster_bed_path, $excl_chrom);#->2782
&readClusterInfo($tssCluster_info_path, $clusterInfoHsh_ref, $pseudocount_correction);#->2852
my ($extended_tssCluster_bed_path) = &generateExtendedCluster($clusterInfoHsh_ref, $tmp_bed_dir, $CRE_extend_size, $CRE_extend_upstrm_ratio);#->1519
...
my ($stranded_CREInfoHsh_ref) = &defineStrandedCRE($clusterInfoHsh_ref, $tmp_bed_dir, $bedtools_bin, $extended_tssCluster_bed_path);#->1239
&summerizeStrandedCREInfo($clusterInfoHsh_ref, $stranded_CREInfoHsh_ref, $geneInfoHsh_ref);#->3339
my ($gene_promoter_CRE_pair_hsh_ref) = &defineGenePromoter($stranded_CREInfoHsh_ref, $geneInfoHsh_ref, $min_total_exp_frac, $min_gene_strand_read_frac, $clusterInfoHsh_ref);#->1092
...
&filterCRE($CREInfoHsh_ref, $clusterInfoHsh_ref, $min_CRE_count);#->1339
...
&summerizeGeneInfo($geneInfoHsh_ref, $trnscptInfoHsh_ref);#->3281
&removeUnsupportedGene($geneInfoHsh_ref, $trnscptInfoHsh_ref);#->3217
&rankCREWithinGene($CREInfoHsh_ref, $geneInfoHsh_ref, $max_gene_num);#->2613
&rankClusterWithinGene($clusterInfoHsh_ref, $geneInfoHsh_ref, $max_gene_num);#->2684
...
my ($gene_promoter_info_hsh_ref) = &generateGenePromoterInfoHsh($CREInfoHsh_ref);#->1588
&printAllBed($result_bed_dir, $geneInfoHsh_ref, $trnscptInfoHsh_ref, $clusterInfoHsh_ref, $CREInfoHsh_ref, $locusInfoHsh_ref, $gene_promoter_info_hsh_ref, $outputPrefix);#->1642
&printTableClusterInfo($result_log_dir, $geneInfoHsh_ref, $trnscptInfoHsh_ref, $clusterInfoHsh_ref, $coding_class_hsh_ref, $outputPrefix);#->2266
&printTableGeneInfo($result_log_dir, $geneInfoHsh_ref, $coding_class_hsh_ref, $outputPrefix);#->2379
&printTableIDMappingInfo($result_log_dir, $CREInfoHsh_ref, $geneInfoHsh_ref, $trnscptInfoHsh_ref, $clusterInfoHsh_ref, $coding_class_hsh_ref, $locusInfoHsh_ref, $outputPrefix);#->2441
&printTableTranscriptInfo($result_log_dir, $geneInfoHsh_ref, $trnscptInfoHsh_ref, $coding_class_hsh_ref, $outputPrefix);#->2510
&printTableCREInfo($result_log_dir, $geneInfoHsh_ref, $trnscptInfoHsh_ref, $clusterInfoHsh_ref, $CREInfoHsh_ref, $coding_class_hsh_ref, $outputPrefix);#->2061
&printTrnscptGtf($result_gtf_dir, $trnscptInfoHsh_ref, $geneInfoHsh_ref, $outputPrefix);#->2565
&printTableCRELocusInfo($result_log_dir, $locusInfoHsh_ref, $outputPrefix);#->2204
&printGenePromoterInfo($result_log_dir, $gene_promoter_CRE_pair_hsh_ref, $geneInfoHsh_ref, $CREInfoHsh_ref, $outputPrefix);#->1862
&removeTmpBedDir($tmp_bed_dir);#->3197
#<\section>
#====================================================================================================================================================#
...
&printOutputFileListAndReadme($ARGVStr, $paramTag, $outDir);#->1907
&printStartOrFinishMessage("finishMessage");#->2027
#<\section>
#====================================================================================================================================================#
...
#	dependOnSub: reportAndLogStatus|3259
#	appearInSub: >none
...
#....................................................................................................................................................#
#	subroutineCategory: unassigned
#	dependOnSub: generateAddonGene|1375, generateAddonTranscript|1423, reportAndLogStatus|3259
#	appearInSub: >none
#	primaryAppearInSection: 3_readInfo|213
#	secondaryAppearInSection: >none
...
#....................................................................................................................................................#
	...
	foreach my $CREID (sort {$CREInfoHsh_ref->{$b}{'sumClusterRead'} <=> $CREInfoHsh_ref->{$a}{'sumClusterRead'}} keys %{$CREInfoHsh_ref}) {
		...
		if ($gene_promoter eq 'none') {
			my ($geneID, $addon_g_strand) = &generateAddonGene($CREInfoHsh_ref, $clusterInfoHsh_ref, $CREID);#->1375
			$addon_gene_num++;
			...
			&generateAddonTranscript($CREInfoHsh_ref, $CREID, $geneInfoHsh_ref, $geneID, $clusterInfoHsh_ref, $trnscptInfoHsh_ref, $addon_length, $chrom_size_hsh_ref, $status, $addon_t_prefix_hsh_ref);#->1423
...
#....................................................................................................................................................#
	...
	{
		my $stdOut = `$bigWigAverageOverBed_bin --version 2>&1`;
		if ($stdOut =~ m/bigwigaverageoverbed\s+v?\s*([\d\.]+(?:-[a-zA-Z0-9]+)?)\b/) {
    		&reportAndLogStatus("Checking: bigWigAverageOverBed version: $1", 0, "\n");
		} 
		elsif (`$bigWigAverageOverBed_bin 2>&1` =~ m/bigwigaverageoverbed\s+v?\s*([\d\.]+(?:-[a-zA-Z0-9]+)?)\b/) {
    		&reportAndLogStatus("Checking: bigWigAverageOverBed version: $1", 0, "\n");
		} else {
    		die "Error: bigWigAverageOverBed is not installed properly or not in PATH. Quitting.\n";
		}
	}
...
#	dependOnSub: >none
#	appearInSub: printStartOrFinishMessage|2027, reportAndLogStatus|3259
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 2_defineOutDirPath|189, 4_finishingTasks|254
#	input: none
#	output: $runTime
#	toCall: my ($runTime) = &currentTime();
#	calledInLine: 158, 2043, 2047, 2052, 2056, 3275, 3276
#....................................................................................................................................................#
...
#....................................................................................................................................................#
#	subroutineCategory: unassigned
#	dependOnSub: reportAndLogStatus|3259, transferStrandedCREData|3424
#	appearInSub: >none
#	primaryAppearInSection: 3_readInfo|213
#	secondaryAppearInSection: >none
...
#....................................................................................................................................................#
	...
	foreach my $CREID (keys %{$stranded_CREInfoHsh_ref}) {
		if ($stranded_CREInfoHsh_ref->{$CREID}{'gene_promoter'} eq 'none') {
			...
			my $CREIDStr = $CREID;
			&transferStrandedCREData($chrom, $start, $end, $strand, $gene_promoter, $CREIDStr, $CREInfoHsh_ref, $stranded_CREInfoHsh_ref, $clusterInfoHsh_ref);#->3424
		}
	}
...
#....................................................................................................................................................#
#	subroutineCategory: unassigned
#	dependOnSub: defineStitchDistance|1206, reportAndLogStatus|3259
#	appearInSub: >none
#	primaryAppearInSection: 3_readInfo|213
#	secondaryAppearInSection: >none
	...
	foreach my $proximity (keys %{$proximity_hsh_ref}) {
		...
		if ($proximity eq 'distal') {
			...
			if ($distal_stitch_distance eq 'undefined') {
				($final_stitch_distance) = &defineStitchDistance($distal_stitch_distance, $distal_CRE_bed, $tmp_bed_dir, $bedtools_bin, $max_dist_rank, $Rscript_bin, $optimize_tangent_R, $result_plot_dir);#->1206
			} else {
		...
		foreach my $locusID (keys %{$locusInfoHsh_ref}) {
			next if $locusInfoHsh_ref->{$locusID}{'proximity'} ne $proximity;
			...
			my $rgbItem = '';
			if ($proximity eq 'distal') {
				if ($total_count >= $hyperactive_cutoff and $spreadness >= $min_spreadness) {#---[2022/06/30 22:29] spreadness cutoff only for distal locus
					$rgbItem = '230,97,1';
					$hyperactive = 'yes';
					$num_hyperactive++;
				} else {
			...
			} elsif ($proximity eq 'proximal') { 
				if ($total_count >= $hyperactive_cutoff)  {
					$hyperactive = 'yes';
					$num_hyperactive++;
					$rgbItem = '123,50,148';
				} else {
...
#	subroutineCategory: unassigned
#	dependOnSub: reportAndLogStatus|3259
#	appearInSub: defineCRELocus|863
#	primaryAppearInSection: >none
...
#	subroutineCategory: unassigned
#	dependOnSub: >none
#	appearInSub: printTrnscptGtf|2565
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 3_readInfo|213
...
#....................................................................................................................................................#
	...
	foreach my $CREID (keys %{$CREInfoHsh_ref}) {
		...
		$gene_promoter_info_hsh_ref->{$CREID}{'CREName'} = $CREName;
	}
...
#....................................................................................................................................................#
	...
	{
		my $filePath = "$result_bed_dir/$outputPrefix.gene_promoter.annot.bed.gz";
		$globalReadmeHsh_ref->{$filePath}{'description'} = "It contains ranges of all CRE that are gene promoters, with CRE name (i.e. gene annotation) at 4th column. Annotated gene promoters are green and unannotated promoters are grey";
		open OUTBED, "| sort -k1,1 -k2,2n | gzip -c >$filePath";
	
		foreach my $CREID (keys %{$gene_promoter_info_hsh_ref}) {
			my @bedAry = @{$gene_promoter_info_hsh_ref->{$CREID}{'bedLine'}};
			$bedAry[8] = $gene_promoter_info_hsh_ref->{$CREID}{'rgbItem'};
			$bedAry[3] = $gene_promoter_info_hsh_ref->{$CREID}{'CREName'};
			print OUTBED join "", (join "\t", (@bedAry)), "\n";
		}
		close OUTBED;
	}
...
#....................................................................................................................................................#
	...
	my @headerAry = ('locusID', 'locusStr', 'locusName', 'proximity', 'chrom', 'start', 'end', 'size', 'CREnum', 'total_count', 'top_count', 'top_frac', 'spreadness', 'hyperactive', 'CREID_str');
	...
	$globalReadmeHsh_ref->{$filePath}{'header'}{'locusStr'} = '[string] Locus string in format of chrom:start-end';
	...
	foreach my $locusID (sort keys %{$locusInfoHsh_ref}) {
		...
		print DLLOG join "", (join "\t", ($locusID, $locusStr, $locusName, $proximity, $chrom, $start, $end, $size, $CREnum, $total_count, $top_count, $top_frac, $spreadness, $hyperactive, $CREID_str)), "\n";
...
#....................................................................................................................................................#
	...
	foreach my $geneID (sort keys %{$geneInfoHsh_ref}) {
		...
		foreach my $trnscptID (keys %{$geneInfoHsh_ref->{$geneID}{'trnscptID'}}) {
			...
			my ($gtf_ary_ref) = &exonRngToGtf($exonRngAry_ref, $chrom, $strand, $trnscptID, $geneID, $sourceTag);#->1315
...
#....................................................................................................................................................#
	...
	GetOptions 	(
		...
		"pseudocount_correction:i"		=>	\$pseudocount_correction,
	...
	return($addon_length, $up_end5Rng, $dn_end5Rng, $tssCluster_bed_path, $tssCluster_info_path, $CRE_extend_size, $CRE_extend_upstrm_ratio, $genome, $distal_stitch_distance, $min_total_exp_frac, $min_gene_strand_read_frac, $min_spreadness, $proximal_extend_nt, $min_CRE_count, $pseudocount_correction, $Rscript_bin, $excl_chrom, $outputPrefix, $outDir, $overwrite);
}
...
#	dependOnSub: currentTime|736
#	appearInSub: addAnnoGeneInfoLoc|309, addonTranscriptGene|358, assignClusterGenePromoter|459, assignClusterRegion|499, checkAllExecutable|594, checkRScriptVersion|674, defineCRE|754, defineCRELocus|863, defineGenePromoter|1092, defineStitchDistance|1206, defineStrandedCRE|1239, filterCRE|1339, generateExtendedCluster|1519, printAllBed|1642, printEnd5Bed|1781, printGenePromoterInfo|1862, printTableCREInfo|2061, printTableCRELocusInfo|2204, printTableClusterInfo|2266, printTableGeneInfo|2379, printTableIDMappingInfo|2441, printTableTranscriptInfo|2510, rankCREWithinGene|2613, rankClusterWithinGene|2684, readClusterBed|2782, readClusterInfo|2852, readGeneInfo|2913, readTranscriptBed|3056, readTranscriptInfo|3135, removeTmpBedDir|3197, removeUnsupportedGene|3217, summerizeGeneInfo|3281
#	primaryAppearInSection: >none
...
#	calledInLine: 323, 372, 473, 513, 533, 583, 615, 620, 629, 638, 647, 656, 665, 693, 699, 773, 793, 805, 885, 903, 909, 958, 963, 1011, 1105, 1201, 1230, 1234, 1254, 1297, 1352, 1370, 1533, 1670, 1693, 1795, 1880, 2079, 2193, 2198, 2222, 2284, 2368, 2373, 2393, 2455, 2461, 2528, 2678, 2750, 2846, 2866, 2927, 2980, 3074, 3083, 3149, 3192, 3211, 3237, 3247, 3295
#....................................................................................................................................................#
