...
* [**scafe.tool.sc.bam\_to\_mdpt**](#8) ---> tool, single-cell mode, convert bam to ctss
* [**scafe.tool.sc.bam\_to\_ctss**](#9) ---> tool, single-cell mode, convert bam to ctss
* [**scafe.tool.cm.remove\_strand\_invader**](#10) ---> tool, common mode, remove strand invader artefact
* [**scafe.tool.cm.prep\_genome**](#11) ---> tool, common mode, prepare custom reference genome
* [**scafe.tool.cm.merge**](#12) ---> tool, common mode, merge clusters from multiple samples
* [**scafe.tool.cm.filter**](#13) ---> tool, common mode, filter for genuine TSS clusters
* [**scafe.tool.cm.directionality**](#14) ---> tool, common mode, calculate directionality of tCREs
...
* [**scafe.tool.cm.annotate.ATAC**](#17) ---> tool, common mode, define and annotate tCRE
* [**scafe.tool.cm.annotate**](#18) ---> tool, common mode, define and annotate tCRE
* [**scafe.tool.cm.aggregate**](#19) ---> tool, common mode, aggregate ctss of multiple samples
* [**scafe.tool.bk.subsample\_ctss**](#20) ---> tool, bulk mode, subsample ctss
* [**scafe.tool.bk.count**](#21) ---> tool, bulk mode, count ctss within tCREs
* [**scafe.tool.bk.bam\_to\_ctss.debug**](#22) ---> tool, bulk mode, convert bam to ctss bed
* [**scafe.tool.bk.bam\_to\_ctss**](#23) ---> tool, bulk mode, convert bam to ctss bed
* [**scafe.download.resources.genome**](#24) ---> &download, reference genome to resources dir
* [**scafe.download.demo.input**](#25) ---> &download, demo input data for testing
* [**scafe.demo.test.run**](#26) ---> demo, run demo data for testing
* [**scafe.check.dependencies**](#27) ---> check dependencies
...
```
 Usage:
   ...
   --run_tag                       <required> [string] prefix for the output files
   --run_outDir                    <required> [string] directory for the output files
   --exclude_chrom                 (optional) [string] chrom to be excluded, comma delimited, 
                                                       e.g. chrM,chrY
   --training_signal_path          (optional) [string] quantitative signal (e.g. ATAC -logP, in bigwig format), or binary genomic 
                                                       regions (e.g. annotated CRE, in bed format) used for training of logical 
                                                       regression model If null, $usr_glm_model_path must be supplied for 
   ...
   --testing_signal_path           (optional) [string] quantitative signal (e.g. ATAC -logP, in bigwig format), or binary genomic 
                                                       ...
                                                       of the logical regression model. If null, annotated TSS from $genome will be 
                                                       used as binary genomic regions. (default=null)
   --TSS_mode                     (optional) [string]  softclip or first_match. if 'softclip', TSS will be determined by 
                                                       softclip postiion, if 'first_match', TSS will be determined by 
                                                       the first nt that match to genome. if detect_TS_oligo is trim, 
                                                       TSS_mode will be forced to be first_match (default=first_match)
...
### scafe.tool.sc.bam\_to\_mdpt [[top]](#0)<a name="8"></a>
...
### scafe.tool.sc.bam\_to\_ctss [[top]](#0)<a name="9"></a>
   This tool converts a bam file to a ctss bed file, identifies read 5'end (capped TSS, i.e. ctss),
   extracts the unencoded G information, pileup ctss, and deduplicate the UMI
...
### scafe.tool.cm.remove\_strand\_invader [[top]](#0)<a name="10"></a>
...
### scafe.tool.cm.merge [[top]](#0)<a name="12"></a>
...
### scafe.tool.cm.directionality [[top]](#0)<a name="14"></a>
...
```
 Usage:
   ...
   --min_nt_count                (optional) [integer] minimum number of nucleotide within a cluster has at least 1 count, based on count_ctss_bed_path (default = 2)
...
### scafe.tool.cm.annotate.ATAC [[top]](#0)<a name="17"></a>
   This tool defines tCRE from TSS clusters and annotates them based their overlap with gene models.

```
 Usage:
   scafe.tool.cm.annotate [options] --CRE_bed_path --CRE_info_path --genome --outputPrefix --outDir
    
   --CRE_bed_path         <required> [string] bed file contains the ranges of filtered TSS clusters,
 ...
 To demo run, cd to SCAFE dir and run:
   ...
   --overwrite=yes \
   --CRE_bed_path=./demo/output/sc.solo/filter/demo/bed/demo.tssCluster.default.filtered.bed.gz \
   --CRE_info_path=./demo/output/sc.solo/filter/demo/log/demo.tssCluster.log.tsv \
   --genome=hg19.gencode_v32lift37 \
   --outputPrefix=demo \
   --outDir=./demo/output/sc.solo/annotate/
```

### scafe.tool.cm.annotate [[top]](#0)<a name="18"></a>
   This tool defines tCRE from TSS clusters and annotates them based their overlap with gene models.
...
```
 Usage:
   ...
   --min_CRE_count              (optional) [integer] minimum num of UMI/read count of within the TSScluster of the non-promoter CRE,
                                                     i.e. non-promoter CREs small than this number will be removed (default = 5)
   --pseudocount_correction     (optional) [integer] will subtract this value (pseudocount added) from the count and summit count value 
                                                     in the tssCluster info table (default = 1)
...
### scafe.tool.cm.aggregate [[top]](#0)<a name="19"></a>
...
### scafe.tool.bk.subsample\_ctss [[top]](#0)<a name="20"></a>
...
### scafe.tool.bk.count [[top]](#0)<a name="21"></a>
...
### scafe.tool.bk.bam\_to\_ctss.debug [[top]](#0)<a name="22"></a>
...
### scafe.tool.bk.bam\_to\_ctss [[top]](#0)<a name="23"></a>
   This tool converts a bulk CAGE bam file to a ctss bed file, identifies read 5'end 
   (capped TSS, i.e. ctss), extracts the unencoded G information, pileup ctss, 
   and deduplicate the UMI
...
### scafe.download.demo.input [[top]](#0)<a name="25"></a>
...
### scafe.demo.test.run [[top]](#0)<a name="26"></a>
...
### scafe.check.dependencies [[top]](#0)<a name="27"></a>
