...
my ($curntTimeStamp) = &timeStamp();#->842
...
my ($cluster_ctss_bed_path, $count_ctss_bed_path, $min_cluster_count, $min_summit_count, $min_nt_count, $min_paraclu_count, $outputPrefix, $outDir, $overwrite) = &readParameters();#->698
#<\section>
#====================================================================================================================================================#
...
&printStartOrFinishMessage("startMessage");#->664
&logCalledCMDAndScript($ARGVStr, $resultScriptDir, $scriptAbsPath);#->418
...
my ($paraclu_input_path) = &parseParacluInput($cluster_ctss_bed_path, $resultParacluDir);#->443
my ($paraclu_cluster_bed_path) = &runParaclu($paraclu_input_path, $paraclu_bin, $cut_sh_path, $resultParacluDir, $min_paraclu_count);#->772
my ($tssCluster_info_hsh_ref, $paraclu_summit_bed_path) = &generateTssClusterInfoHsh($resultParacluDir, $paraclu_cluster_bed_path, $cluster_ctss_bed_path, $bedtools_bin);#->319
&getTssClusterCount($tssCluster_info_hsh_ref, $count_ctss_bed_path, $paraclu_summit_bed_path, $paraclu_cluster_bed_path, $bedtools_bin);#->384
&printFinalBedAndLog($tssCluster_info_hsh_ref, $resultBedDir, $resultLogDir, $min_cluster_count, $min_summit_count, $min_nt_count, $paramTag);#->491
#<\section>
#====================================================================================================================================================#
...
&printOutputFileListAndReadme($ARGVStr, $paramTag, $outDir);#->549
&printStartOrFinishMessage("finishMessage");#->664
#<\section>
#====================================================================================================================================================#
...
#	dependOnSub: reportAndLogStatus|750
#	appearInSub: >none
#	primaryAppearInSection: 2_ReadInfoAndRun|153
...
#	dependOnSub: >none
#	appearInSub: printStartOrFinishMessage|664, reportAndLogStatus|750
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 1_defineHardCodedParam|131, 3_finishingTasks|166
#	input: none
#	output: $runTime
#	toCall: my ($runTime) = &currentTime();
#	calledInLine: 112, 680, 684, 689, 693, 766, 767
#....................................................................................................................................................#
...
#....................................................................................................................................................#
	...
	foreach my $tssClusterID (keys %{$paraclu_info_hsh_ref}) {
		...
		$tssCluster_info_hsh_ref->{$tssClusterID}{'nt_count'} = 0;
...
#....................................................................................................................................................#
	...
	my $count_bed_hsh_ref = {
		...
		'nt_count' => $paraclu_cluster_bed_path,
	};
	...
	foreach my $count_type (keys %{$count_bed_hsh_ref}) {
		...
		while (<BEDTOOLS>) {
			...
			$count = 1 if $count_type eq 'nt_count'; #---[2022/08/03 12:48] equivalent to counting the position
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 1_defineHardCodedParam|131
#	secondaryAppearInSection: >none
...
#	primaryAppearInSection: 2_ReadInfoAndRun|153
#	secondaryAppearInSection: >none
#	input: $min_cluster_count, $min_nt_count, $min_summit_count, $paramTag, $resultBedDir, $resultLogDir, $tssCluster_info_hsh_ref
#	output: 
#	toCall: &printFinalBedAndLog($tssCluster_info_hsh_ref, $resultBedDir, $resultLogDir, $min_cluster_count, $min_summit_count, $min_nt_count, $paramTag);
#	calledInLine: 161
#....................................................................................................................................................#
	my ($tssCluster_info_hsh_ref, $resultBedDir, $resultLogDir, $min_cluster_count, $min_summit_count, $min_nt_count, $paramTag) = @_;
	...
	print OUTLOG join "", (join "\t", ('tssClusterID', 'chrom', 'chromStart', 'chromEnd', 'size', 'summit_pos',  'stability', 'paraclu_input_cluster_count', 'cluster_count', 'paraclu_input_summit_count', 'summit_count', 'nt_count', 'retained')), "\n";

	$globalReadmeHsh_ref->{$out_log_file_path}{'description'} = "information of the final tssCluster (filtering by min_cluster_count and min_summit_count and nt_count)";
	$globalReadmeHsh_ref->{$out_bed_file_path}{'description'} = "bed file of the final tssCluster (filtering by min_cluster_count and min_summit_count and nt_count). Score column refers to number of read in the paraclu input signal";
	...
	foreach my $tssClusterID (sort keys %{$tssCluster_info_hsh_ref}) {
		...
		my $nt_count = $tssCluster_info_hsh_ref->{$tssClusterID}{'nt_count'};
		my $retained = 'no';
		if ($cluster_count >= $min_cluster_count and $summit_count >= $min_summit_count and $nt_count >= $min_nt_count) {
			$num_retained++;
			$retained = 'yes';
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 3_finishingTasks|166
#	secondaryAppearInSection: >none
...
#	appearInSub: >none
#	primaryAppearInSection: 1_defineHardCodedParam|131, 3_finishingTasks|166
#	secondaryAppearInSection: >none
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 0_startingTasks|123
#	secondaryAppearInSection: >none
#	input: none
#	output: $cluster_ctss_bed_path, $count_ctss_bed_path, $min_cluster_count, $min_nt_count, $min_paraclu_count, $min_summit_count, $outDir, $outputPrefix, $overwrite
#	toCall: my ($cluster_ctss_bed_path, $count_ctss_bed_path, $min_cluster_count, $min_summit_count, $min_nt_count, $min_paraclu_count, $outputPrefix, $outDir, $overwrite) = &readParameters();
#	calledInLine: 126
#....................................................................................................................................................#
	
	my ($cluster_ctss_bed_path, $count_ctss_bed_path, $min_cluster_count, $min_summit_count, $min_nt_count, $min_paraclu_count, $outputPrefix, $outDir, $overwrite);
	...
	return($cluster_ctss_bed_path, $count_ctss_bed_path, $min_cluster_count, $min_summit_count, $min_nt_count, $min_paraclu_count, $outputPrefix, $outDir, $overwrite);
}
sub reportAndLogStatus {
#....................................................................................................................................................#
#	subroutineCategory: log
#	dependOnSub: currentTime|301
#	appearInSub: checkAllExecutable|201, generateTssClusterInfoHsh|319, parseParacluInput|443, printFinalBedAndLog|491, runParaclu|772
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 2_ReadInfoAndRun|153
#	input: $lineEnd, $message, $numTrailingSpace
#	output: 
#	toCall: &reportAndLogStatus($message, $numTrailingSpace, $lineEnd);
#	calledInLine: 224, 229, 238, 247, 256, 265, 274, 283, 292, 335, 459, 486, 504, 543, 544, 793, 819
#....................................................................................................................................................#
